...
const Header = () => {
  ...
  return (
    <header className="navbar navbar-expand-md navbar-dark bg-dark sticky-top shadow-lgborder-bottom border-warning border-opacity-25">
      <div className="container">
        ...
        <div className={`collapse navbar-colapse ${isMobileMenuOpen ? 'show' : ''}`} id="navbarNav">
          ...
          <div className="d-flex align-items-center mt-3 mt-md-0">
            ...
            <a href={`tel: ${RESTAURANT_PHONE}`} className="btn btn-warning text-dark fw-bold rounded-pill shadow d-flex align-items-center py-2 px-3">
