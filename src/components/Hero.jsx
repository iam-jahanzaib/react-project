...
<h2 className="display-3 fw-bold text-warning font-serif mb-4">Taste the Tradition</h2>
...
<a href="#menu" className="btn btn-warning text-dark fw-bold py-3 px-5 rounded-pill fs-5 shadow-lg">
View Our Menu</a>
</div>
</section>
);
